...
VALUES
  ...
  ('401bcc38-05d0-4dc3-b826-cc1e2d46e7ad', 'user4', 'Mario', NOW()),
  ('6f050e32-8b4e-45d7-a5a7-156155c37dbf', 'user5', 'Luigi', NOW()),
  ('cf0529d9-f8c9-4da2-a4f9-bec222711a49', 'user6', 'RAID: Shadow Legends', NOW()),
  ('bd5015df-4c8d-408e-a598-161f26ac1cd5', 'user7', 'Kevin', NOW()),
  ('04f73e2a-1c70-4591-9f54-e13c269a8de6', 'user8', 'Master Chief', NOW()),
  ('7d0bd679-087d-4efa-bb1f-06606457fee7', 'user9', 'Abraham Lincoln', NOW()),
  ('3ec69434-c440-4c21-83ce-4a1276bf1c7d', 'user10', 'Mickey Mouse', NOW()),
  ('91e2c5ff-4243-4141-9688-4344396499bd', 'user11', 'Yoda', NOW()),
  ('6dd2c10d-8500-4481-996c-1c365ca8f984', 'user12', 'Darth Vader', NOW()),
  ('12a4c043-e59a-4eaa-b935-81493f88b79e', 'user13', 'Basement Gamer Beast 9000', NOW()),
  ('59a6157e-bba2-4372-a0d0-ff1d03ca9ee1', 'user14', 'Sherman Cletus', NOW()),
  ('66f7ac38-29a0-4800-aab0-54d6f59c51fa', 'user15', 'Spongebob', NOW()),
  ('daff9776-bcf3-40eb-9e3d-05684af0cf88', 'user16', 'Squidward', NOW()),
  ('dd926ae3-46ba-440c-8eb7-e929e504faec', 'user17', 'Chef Cecil Crookshank', NOW()),
  ('287e9a76-7588-43f6-a26f-a2f0dd0fa13b', 'user18', 'Chet Fireball', NOW()),
  ('81d98bfb-818b-4bb9-903f-ec77eca59862', 'user19', 'Chad', NOW()),
  ('1c2d480f-89c5-4c89-97e8-b30e1e9891df', 'user20', 'Jimmy''s Bets', NOW());
